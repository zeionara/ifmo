...
<%@page language="java" import="controller.PontoExListBean" %>
...
<html>
  ...
  <body>
    ...
    <jsp:useBean id="pontos" class="controller.PontoExListBean" scope="session"/>
    <jsp:getProperty name="pontos" property="pontosTable"/>
  </body>
</html>

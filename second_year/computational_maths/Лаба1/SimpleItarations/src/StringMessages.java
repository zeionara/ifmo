...
public class StringMessages {
    ...
    public static final String GENERATED_KOEFF = "Generated koefficients: ";
    public static final String GENERATED_MEMB = "Generated free members: ";
    ...
    public static final String WRONG_RESOLVE = "This system is wrong, it has no resolves or has infinity number of resolves.";

    //
    // Showing answer
    //

    public static final String FAIL_ITERATION = "Too many iterations. Program failed.";

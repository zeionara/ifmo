...
public class ConsoleController {
    ...
    public static void main(String... args){
        ...
        while(true) {
            ...
            try {
                rangeleft = getDouble("Now type first bound of integration area here:",
            ...
            // Getting second value of range
            try {
                rangeright = getDouble("Now type second bound of integration area here:",
            ...
            // Getting accuracy
            try {
                accuration = getDouble("Now type accuration of integration:",

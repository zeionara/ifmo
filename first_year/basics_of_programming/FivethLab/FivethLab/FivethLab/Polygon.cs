...
public class Polygon
{
    ...
    public override string ToString()
    {
        ...
        outputString = AppendSidesToString(outputString);
        return outputString;
    }

    protected string AppendSidesToString(string outputString)
    {
        for (int i = 0; i < numberOfSides; i++)
        {
            if (i != 0)
    ...
    public Polygon GetDefaultPolygon<T>()
        where T : Polygon
    {
        return default(T);
    }
